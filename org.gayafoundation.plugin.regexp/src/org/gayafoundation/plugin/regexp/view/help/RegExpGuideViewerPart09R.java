...
public class RegExpGuideViewerPart09R extends TwoColumnTitledTable {
	
	public RegExpGuideViewerPart09R(Composite parent, int titleStyle, int tableStyle) {
	...
	protected void createUI() {
		...
		setTitle("Reluctant quantifiers");
